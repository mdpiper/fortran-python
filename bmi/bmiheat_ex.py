...
grid_spacing = np.empty(grid_rank, dtype=np.float32)
m.get_grid_spacing(grid_id, grid_spacing)
print(' - spacing:', grid_spacing)
grid_origin = np.empty(grid_rank, dtype=np.float32)
...
grid_x = np.empty(max(grid_rank, 1), dtype=np.float32)
m.get_grid_x(grid_id, grid_x)
print(' - x:', grid_x)
grid_y = np.empty(max(grid_rank, 1), dtype=np.float32)
m.get_grid_y(grid_id, grid_y)
print(' - y:', grid_y)
grid_z = np.empty(max(grid_rank, 1), dtype=np.float32)
