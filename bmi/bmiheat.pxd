cdef extern from "bmi_interoperability.h":
    ...
    int get_grid_spacing(int model, int grid_id, double *spacing, int rank)
    int get_grid_origin(int model, int grid_id, double *origin, int rank)
    int get_grid_x(int model, int grid_id, double *x, int size)
    int get_grid_y(int model, int grid_id, double *y, int size)
    int get_grid_z(int model, int grid_id, double *z, int size)
